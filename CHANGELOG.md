...
* /lookup full response ([d8df543](https://github.com/devwars/devwars-api/commit/d8df54301fa4945dc7106d15a045feddd4e84a5c))
...
* endpoint for gathering standard and error logs ([7159231](https://github.com/devwars/devwars-api/commit/71592319a8426efeea1e583809df44144ef71c7a))
...
* implementation of the games lookup endpoint ([6ac03c8](https://github.com/devwars/devwars-api/commit/6ac03c8214f555fe4833fce2b1ef8caff4eba4c3))
* implemented paging for games ([18c27ea](https://github.com/devwars/devwars-api/commit/18c27ea703cba6342a49f8d298e384e22b2222f3))
* implemented paging for schedules ([af86637](https://github.com/devwars/devwars-api/commit/af86637550098cc3c39fa40ca42e14d6a8a63bf0))
* implemented support for paging with cursors ([cabcdf4](https://github.com/devwars/devwars-api/commit/cabcdf4a230cac3fe190368048874a3408b559cc))
* implemented support for paging with cursors ([1dfd8e3](https://github.com/devwars/devwars-api/commit/1dfd8e3cbf128854291993bbcb5472d1ab04ac86))
...
* linked account connection tests ([668458a](https://github.com/devwars/devwars-api/commit/668458a3fec5b16ff94bc3d48c2240690eb44039))
...
* process env for twitch ([a684b7c](https://github.com/devwars/devwars-api/commit/a684b7c6efc84675a297e3a06d0a1aa2601fdc9c))
* returning support for game results being stored and wins updated ([453f90f](https://github.com/devwars/devwars-api/commit/453f90f72469eb454bb66bd406f55f96dd4aab5d))
...
* support assinging multiple languages ([49668c4](https://github.com/devwars/devwars-api/commit/49668c4ed026317d7d6558939738db7be0edf6c7))
...
* support for banning users ([4bb4ac6](https://github.com/devwars/devwars-api/commit/4bb4ac65604d9c3943c3c3c2baf85e96ed166fc3))
...
* updating usernames now requires waiting between changes ([7c4b4ab](https://github.com/devwars/devwars-api/commit/7c4b4ab8d14e0d5529c68f87d390319c08184cbf))
...
* **authentication:** json web tokens ([932f488](https://github.com/devwars/devwars-api/commit/932f488373d5217a5c02c4bbbcd77e40fa2de48e))
...
* **email-migration:** Ensured that email permission table is migrated ([66ccd13](https://github.com/devwars/devwars-api/commit/66ccd13293f069df9f1645f243b98fb77cce9bf0))
* **game-patch:** schema for validating game patch data ([053b82c](https://github.com/devwars/devwars-api/commit/053b82ce0b99c0b67133fdc01562c3c483050315))
* **linked-account:** default constructor ([347494a](https://github.com/devwars/devwars-api/commit/347494a76e4c77a0f09cbc4a4419684949aa1c9a))
* **linked-account-schema:** updating twitch coins now gets schema validation ([6060594](https://github.com/devwars/devwars-api/commit/606059410ae4f07ab424e47ac762705a79859dee))
...
* **logger:** introduction of winston logging ([dd3a94f](https://github.com/devwars/devwars-api/commit/dd3a94f3242ff9816d79e5e7c346b9107a64c4d6))
...
* **test:** changing test config logic and first back ([3927d16](https://github.com/devwars/devwars-api/commit/3927d1675fa9ff39ce937c15e8b4e7de61f044e7))
* **try-catch:** async middlewares and handlers ([84d99af](https://github.com/devwars/devwars-api/commit/84d99af56573dfaad344608484a45ba31e99d375))
* **unsubscribe:** email unsubscribe link will now direct to the correct ([44fa473](https://github.com/devwars/devwars-api/commit/44fa47373552f0af6132b5a7a343ad590e5184ed))
* **user:** toJSON ([ffcef73](https://github.com/devwars/devwars-api/commit/ffcef7386afc3394e2bda7a23ac3a587888ad533))
...
* bot routes now supported for users ([1b00adf](https://github.com/devwars/devwars-api/commit/1b00adf611d0c9906e30bf741e3821fc8c881885))
* defult profile image to null when pushing to firebase ([2274143](https://github.com/devwars/devwars-api/commit/2274143ea2e3b7a9591bd5966b367af5974c125b))
...
* don't expand out the game storage object ([c26ba70](https://github.com/devwars/devwars-api/commit/c26ba70bf881c61409c2a5f3edf69cc31eba857c))
* dont sync leaderboards ([ae3006b](https://github.com/devwars/devwars-api/commit/ae3006b56d0fdc01432412e3b198cc2c4b90f511))
* dont update password through account update route ([0b2eae3](https://github.com/devwars/devwars-api/commit/0b2eae35d8964ed450253a2ffb68b3889e6a6cdf))
* dont update password through account update route ([349c522](https://github.com/devwars/devwars-api/commit/349c5226be3855b829db6d1c812018d1593c6cc6))
* ensure client id is provided when gathering authenicated user ([99e8301](https://github.com/devwars/devwars-api/commit/99e8301296ca962c170bb125b9617629e45d817b))
...
* ensure to check the last not future when updating usernames ([24967d1](https://github.com/devwars/devwars-api/commit/24967d1897d5475e311e985f15e39f370fec8657))
* ensure to set assigned languages to a empty array if no languages are assigned ([ca310d4](https://github.com/devwars/devwars-api/commit/ca310d48fcf405cfa81e4a6be9aeb627e8f32f31))
...
* fix paging backwards ordering options ([71e2a02](https://github.com/devwars/devwars-api/commit/71e2a02ce7a66a820792436b14d12410668eb0a4))
* fixed executing tests ([a150e83](https://github.com/devwars/devwars-api/commit/a150e839dc5b3a347ad2c9045321c87fc825b261))
* game?players=true now only gathers required user properties ([0ea4b3b](https://github.com/devwars/devwars-api/commit/0ea4b3b45c444540f39783aa06832f8cd97d9bb6))
* leaderboard uses paging and fix twitch login ([f19459a](https://github.com/devwars/devwars-api/commit/f19459af0064c45ff7e34c09fcb00832d570280a))
* missing superagent types ([cba3661](https://github.com/devwars/devwars-api/commit/cba3661b3eebd3a924823a72424b8fc34224fd43))
* profile updates and sex enum ([67c6ab3](https://github.com/devwars/devwars-api/commit/67c6ab3b7deeb94b1692e8fe26aa116e7bde0aef))
...
* Remove deprecated package and tslint fixes ([09006b4](https://github.com/devwars/devwars-api/commit/09006b480dda539e8cb46e64be5f37c9871d5e8c))
...
* typo in run seed command that prevents seeding db ([4e2596d](https://github.com/devwars/devwars-api/commit/4e2596d771c2173ef61d2e1b96a9b7191750fe83))
...
* **cases:** fixes related file cases and import cases ([de1b3c5](https://github.com/devwars/devwars-api/commit/de1b3c59e78c0af4d52e4eb190e17c00665348d5))
...
* **env:** ensure eample has firebase url ([fde6f3c](https://github.com/devwars/devwars-api/commit/fde6f3ca3a884532bc16f98103dd2cc806d60461))
...
* **seed-production:** dont create the user again if it already exists ([57d4985](https://github.com/devwars/devwars-api/commit/57d4985d716840a031194b56f54ae39f7ff977ce))
...
* **reverify:** reverify correctly recates and resends out verification email ([c46ac6f](https://github.com/devwars/devwars-api/commit/c46ac6ff6c48fc64699b92c16f75bc88f6eecbec))
* **temp-route:** temp route must ensure authentication ([b7bf3ca](https://github.com/devwars/devwars-api/commit/b7bf3cae4063b7da6f336ff6a58f082fdb039794))
