...
describe('game', () => {
    ...
    it('GET - games', async () => {
        const game1 = await GameFactory.default().save();
        const game2 = await GameFactory.default().save();
    ...
    it('GET - games/:id', async () => {
        const game1 = await GameFactory.default().save();
        const game2 = await GameFactory.default().save();
        const game3 = await GameFactory.default().save();
    ...
    it('GET - games/season/:season', async () => {
        await GameFactory.withSeason(2).save();
        await GameFactory.withSeason(2).save();
        await GameFactory.withSeason(3).save();
        await GameFactory.withSeason(1).save();
